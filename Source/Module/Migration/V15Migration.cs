...
internal static class V15Migration
{
    ...
    {
        new("Bird Squawk", new[] { SFX.game_gen_bird_squawk }, s => s.BirdSquawk, (s, v) => s.BirdSquawk = v),
        new("Broken Window", new[] { SFX.env_loc_03_brokenwindow_large_loop, SFX.env_loc_03_brokenwindow_small_loop }, s => s.BrokenWindow, (s, v) => s.BrokenWindow = v),
        new("Conveyor", new[] { SFX.game_09_conveyor_activate, SFX.env_loc_09_conveyer_idle }, s => s.Conveyor, (s, v) => s.Conveyor = v),
        new("Core Block", new[]
        {
        ...
        new("Death", new[] { SFX.char_mad_death, SFX.char_mad_predeath }, s => s.Death, (s, v) => s.Death = v),
        new("Respawn", new[] { SFX.char_mad_revive }, s => s.Respawn, (s, v) => s.Respawn = v),
        new("Golden Death", new[] { SFX.char_mad_death_golden }, s => s.GoldenDeath, (s, v) => s.GoldenDeath = v),
        new("Dialogue", new[]
        {
        ...
        new("Dream Block", new[] { SFX.char_mad_dreamblock_enter, SFX.char_mad_dreamblock_exit, SFX.char_mad_dreamblock_travel }, s => s.DreamBlock, (s, v) => s.DreamBlock = v),
        new("Drum Swap Block", new[]
        {
        ...
        new("Fireball", new[] { SFX.env_loc_09_fireball_idle }, s => s.FireballIdle, (s, v) => s.FireballIdle = v),
        new("Heart Collect", new[] { SFX.game_gen_crystalheart_blue_get, SFX.game_gen_crystalheart_red_get, SFX.game_gen_crystalheart_gold_get }, s => s.HeartCollect, (s, v) => s.HeartCollect = v),
        new("Item Crystal Death", new[] { "event:/cherryhelper/itemcrystal_death" }, s => s.ItemCrystalDeath, (s, v) => s.ItemCrystalDeath = v),
        new("Kevin Block", new[]
        {
        ...
        new("Lava Barrier", new[] { SFX.env_loc_09_lavagate_idle }, s => s.LavaBarrier, (s, v) => s.LavaBarrier = v),
        new("Lightning Ambience", new[] { SFX.env_amb_10_electricity }, s => s.LightningAmbience, (s, v) => s.LightningAmbience = v),
        new("Lightning Strike", new[] { SFX.game_10_lightning_strike }, s => s.LightningStrike, (s, v) => s.LightningStrike = v),
        new("Move Block", new[]
        {
        ...
        new("Pico-8 Flag", new[] { SFX.game_10_pico8_flag }, s => s.Pico8Flag, (s, v) => s.Pico8Flag = v),
        new("Seeker", new[]
        {
        ...
        new("Spring", new[] { SFX.game_gen_spring }, s => s.Spring, (s, v) => s.Spring = v),
        new("Touch Switch Complete", new[] { SFX.game_gen_touchswitch_last_cutoff, SFX.game_gen_touchswitch_last_oneshot }, s => s.TouchSwitchComplete, (s, v) => s.TouchSwitchComplete = v),
        new("Farewell Wind", new[] { SFX.env_amb_10_voidspiral }, s => s.FarewellWind, (s, v) => s.FarewellWind = v),
        new("Ridge Wind", new[] { SFX.env_amb_04_main }, s => s.RidgeWind, (s, v) => s.RidgeWind = v),
        new("Zip Mover", new[]
        {
