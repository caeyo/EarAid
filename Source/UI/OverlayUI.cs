...
/// <summary>
/// Shared behaviour for fullscreen overlays: text-input plumbing, mute
...
/// </summary>
public abstract class OverlayUI : Entity
{
    ...
    protected static float WrappedLineStep => WrappedList.LineStep(ListRowScale);
